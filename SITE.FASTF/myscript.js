...
function myFunctionCloseFive() {
    document.getElementById("image-block-5").setAttribute("style", "display:none;");
}
...
function myFunctionCloseSeven() {
    document.getElementById("image-block-7").setAttribute("style", "display:none;");
}
function myFunctionCloseEight() {
    document.getElementById("image-block-8").setAttribute("style", "display:none;");
}
...
function myFunctionFive() {
    var x = document.getElementById("image-block-5");
    if (x.style.display === "block") {
        x.style.display = "none";
    } else {
        x.style.display = "block";
...
function myFunctionSeven() {
    var x = document.getElementById("image-block-7");
    if (x.style.display === "block") {
        x.style.display = "none";
    } else {
        x.style.display = "block";
...
function myFunctionEight() {
    var x = document.getElementById("image-block-8");
    if (x.style.display === "block") {
        x.style.display = "none";
    } else {
        x.style.display = "block";
...
dragElement(document.getElementById("main-container-8"));
...
dragElement(document.getElementById("image-block-8"));
